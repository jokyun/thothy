...
export const Composer: FC<ComposerProps> = (props: ComposerProps) => {
  ...
  return (
    <DragAndDropWrapper>
      <ComposerPrimitive.Root className="focus-within:border-aui-ring/20 flex flex-col w-full min-h-[72px] flex-wrap items-center justify-center border px-3 py-1 shadow-sm transition-colors ease-in bg-white rounded-2xl mb-6">
